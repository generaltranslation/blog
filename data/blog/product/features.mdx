...
I'm sure you've experienced some frustrations with internationalization (i18n) libraries.
Just in case you haven't, here are some of the common pain points and bottlenecks:

- To integrate an i18n library, you have to spend time refactoring your code
  - Depending on the size of the project, this could take a long time

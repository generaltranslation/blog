...
description: How to internationalize an AI chatbot in 5 minutes
date: 2025-02-25
author: Brian Lou
---
...
Of course, I couldn't forget to include all of necessary environment variables.
...
All I did was import the `LocaleSelector` component and add it to the `chat-header.tsx` component. I didn't need to do any configuration or middleware routing.

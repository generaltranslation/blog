---
title: gt-next@6.2.0
description: New features and improvements for gt-next
date: 2025-08-19
authors: [ernest] 
...
In **gt-next 6.2.0**, we've taken a big step toward moving computation from runtime to build time through an **SWC plugin**.
...
This means translations are immediately available at runtime — no API calls, no page refreshes.
